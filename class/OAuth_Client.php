...
function get_oauth_client() {
    $provider = new \League\OAuth2\Client\Provider\GenericProvider([
        ...
        //'redirectUri'             => 'https://www.homeaway.com/platform/defaultRedirect',
        'redirectUri'             => "https://{$_SERVER['HTTP_HOST']}/{$_SERVER['REQUEST_URI']}",
        'urlAuthorize'            => 'https://ws.homeaway.com/oauth/authorize',
        'urlAccessToken'          => 'https://ws.homeaway.com/oauth/token',
        'urlResourceOwnerDetails' => 'https://ws.homeaway.com/public/listing'
    ]);
